...
export default function Body({ language }){
  return(
    <div className="md:col-span-2 p-4">
      ...
      <div>
        <h4 className="text-xl mt-4 mb-2 titles">Habilidades</h4>
        <div className="md:grid grid-cols-2 justify-between">
          <div>
            <h5 className="titles">Tecnológicas</h5>
            <ul className="list-disc list-inside">
              <li><Icon icon={html5Icon} inline={true} className="bodyIcon" />HTML5</li>
              <li><Icon icon={css3Icon} inline={true} className="bodyIcon" />CSS</li>
